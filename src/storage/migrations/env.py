...
Imports the application's SQLAlchemy Base so that ``autogenerate`` can detect
model changes, and reads the database URL from application settings.
"""
...
# ---------------------------------------------------------------------------
# Override sqlalchemy.url with the application's DATABASE_URL so that the
# connection string is not duplicated in alembic.ini.
# ---------------------------------------------------------------------------
